...
[Route("/ElectronicWallet/Internal/Rename/{DigiCurrency}", "PUT", Summary = @"Update the name of an address ", Notes = @"")]
public class UpdateElectronicAddress : IReturn<CommonResponse>
{

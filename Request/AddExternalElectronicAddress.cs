...
[Route("/ElectronicWallet/External/New/{DigiCurrency}", "POST", Summary = @"Add an external digital currency addresses to the logged in user. ", Notes = @"")]
public class AddExternalElectronicAddress : IReturn<CommonResponse>
{
...
[ApiMember(Name = "Address", Description = "Public address of wallet", ParameterType = "query", DataType = "string", IsRequired = true)]
public System.String Address {get; set; } 
[ApiMember(Name = "Password", Description = "Require password confirm to add external address", ParameterType = "query", DataType = "string", IsRequired = true)]

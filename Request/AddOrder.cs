...
[Route("/Orders/AddOrder", "POST", Summary = @"Place an order at the exchange.", Notes = @"The account needs to be approved before transfer is possible.")]
...
[ApiMember(Name = "Price", Description = "Price expressed in the first currency of the currency pair. Ex. Regardless if you place a bid or ask BTCUSD, the price is always expressed in the price of one BTC in USD", ParameterType = "query", DataType = "decimal", IsRequired = true)]

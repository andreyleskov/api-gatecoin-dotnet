...
[Route("/ElectronicWallet/Transactions/External/{DigiCurrency}", "POST", Summary = @"Get all external digital currency transactions of the logged in user", Notes = @"")]
public class GetExternalElectronicWalletTransactionsByCurrency : IReturn<ElectronicWalletTransactionsResponse>
{

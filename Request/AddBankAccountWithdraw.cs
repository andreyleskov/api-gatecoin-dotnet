...
[Route("/Bank/BankAccountWithdrawal", "POST", Summary = @"Request a transfer from the traders account of the logged in user. This is only available for bank account", Notes = @"The account transfer needs to be approved.")]
